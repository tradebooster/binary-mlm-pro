...
Epoch.prototype.calConfig = function() //PRIVATE: initialize calendar variables
{
    ...
    this.rangeYearUpper = this.displayYearInitial + 1;
    this.minDate = new Date(1950, 0, 1);
    this.maxDate = new Date(this.displayYearInitial + 1, 11, 31);
...
Epoch.prototype.setDays = function()  //PRIVATE: initializes the standard Gregorian Calendar parameters
{
    ...
    this.monthDayCount = new Array(31, ((this.curDate.getFullYear() - this.displayYearInitial + 1) % 4 ? 28 : 29), 31, 30, 31, 30, 31, 31, 30, 31, 30, 31);
};
//-----------------------------------------------------------------------------
