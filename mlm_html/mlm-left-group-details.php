...
function myLeftGroupDetails($id = '') {
    ...
    <div class="va-matter">
        ...
        <div class="va-matterbox">
            <!--va-headname-->
            <div class="va-headname"><?php _e('My Left Group Details', 'binary-mlm-pro'); ?></div>
            <!--/va-headname-->
            <div class="va-admin-leg-details">
                ...
                <div class="paging">
                    ...
                    <div class="right-members">
                        <?php _e('Total Users', 'binary-mlm-pro'); ?>: <strong><?php echo $leftLegUsers; ?></strong>&nbsp;<?php _e('Active Users', 'binary-mlm-pro'); ?>: <strong><?php echo $leftLegActiveUsers; ?></strong>
                    </div>
