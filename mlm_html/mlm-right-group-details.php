...
function myRightGroupDetails($id = '') {
    ...
    //_e("<pre>");print_r($totalRightLegUsers);exit;
    ?>
    ...
    <?php endforeach; ?>
            ...
            // Set paging configuration options         // Note: these options are changed by the UI controls in the example.
            options['page'] = 'enable';
            options['pageSize'] = 10;
    ...
    <div class="va-matter">
        ...
        <div class="va-matterbox">
            <!--va-headname-->
            <div class="va-headname"><?php _e('My Right Group Details', 'binary-mlm-pro'); ?></div>
            <!--/va-headname-->
            <div class="va-admin-leg-details">
                ...
                <div class="paging">
                    ...
                    <div class="right-members">
                        <?php _e('Total Users', 'binary-mlm-pro'); ?>: <strong><?php echo $rightLegUsers; ?></strong>&nbsp;<?php _e('Active Users', 'binary-mlm-pro'); ?>: <strong><?php echo $rightLegActiveUsers; ?></strong>
                    </div>
